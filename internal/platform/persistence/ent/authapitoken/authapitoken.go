...
const (
	// Label holds the string label denoting the authapitoken type in the database.
	Label = "auth_api_token"
	...
	// Table holds the table name of the authapitoken in the database.
	Table = "auth_api_tokens"
)

// Columns holds all SQL columns for authapitoken fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldName,
...
// OrderOption defines the ordering options for the AuthAPIToken queries.
