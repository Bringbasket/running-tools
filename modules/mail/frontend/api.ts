...
export const mailAPI = {
  ...
  createBatchShareLinks: (count: number, expiresInSeconds: number | null, scope: 'all' | 'gpt_registered' = 'all') => apiRequest<{ items: BatchShareLinkItem[]; count: number; scope: string }>(`${base}/aliases/batch-share-links`, { method: 'POST', body: JSON.stringify({ count, expiresInSeconds, scope }) }),
